...
class Food_Station(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        self.game = game
        self.groups = game.all_sprites
        pygame.sprite.Sprite.__init__(self, self.groups)
        self.game = game
        self.image = food_station_img
        self.image.set_colorkey(PURPLE)
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y

class Work(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        self.game = game
        self.groups = game.all_sprites
        pygame.sprite.Sprite.__init__(self, self.groups)
...
class Console(pygame.sprite.Sprite):
    def __init__(self, game, x):
        ...
        pygame.draw.rect(self.surface, RED, [0, 0, 1075, 100])
